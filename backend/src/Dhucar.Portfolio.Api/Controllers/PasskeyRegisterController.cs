 ...
 * Layer           :  Controller
 * Modified By     :
 * Description     :  Verifies and stores a new passkey.
 */
[Route("api/[controller]")]
[ApiController]
[JwtAuthentication]
[EnableRateLimiting("admin")]
public class PasskeyRegisterController(PasskeyBAL objPasskeyBAL, ICodeLogger codeLog) : ControllerBase
{
    //****************************************************************************************************
    // Layer                 :   Controller
    // Method Name           :   PasskeyRegister
    // Method Description    :   Verifies and stores a new passkey.
    ...
    //****************************************************************************************************
    /// <summary>
    /// <c>PasskeyRegister : </c> Verifies and stores a new passkey.
    /// </summary>
    [HttpPost]
    public async Task<IActionResult> PasskeyRegister([FromBody] PasskeyRegisterRequestDTO objAPIRequest)
    {
        ...
        try
        {
            ...
            {
                objResponse = await objPasskeyBAL.PasskeyRegister(objAPIRequest);
            }
            else
            {
        ...
        catch (Exception ex)
        {
            ...
            codeLog.Error(ex, $"Step {nameof(PasskeyRegister)}", string.Empty, $"Exception in {nameof(PasskeyRegister)} Method");
        }
        stopwatch.Stop();

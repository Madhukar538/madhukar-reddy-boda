...
public class DeleteProjectController(ProjectBAL objProjectBAL, ICodeLogger codeLog) : ControllerBase
{
    //****************************************************************************************************
    // Layer                 :   Controller
    ...
    //****************************************************************************************************
    /// <summary>
    /// <c>DeleteProject : </c> Deletes a project.
    /// </summary>
    [HttpPost]
    public async Task<IActionResult> DeleteProject([FromBody] DeleteItemRequestDTO objAPIRequest)
    {
        ...
        try
        {
            ...
            {
                objResponse = await objProjectBAL.DeleteProject(objAPIRequest);
            }
            else
            {
        ...
        catch (Exception ex)
        {
            ...
            codeLog.Error(ex, $"Step {nameof(DeleteProject)}", string.Empty, $"Exception in {nameof(DeleteProject)} Method");
        }
        stopwatch.Stop();

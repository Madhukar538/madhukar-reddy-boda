...
public class DeletePostController(PostBAL objPostBAL, ICodeLogger codeLog) : ControllerBase
{
    //****************************************************************************************************
    // Layer                 :   Controller
    ...
    //****************************************************************************************************
    /// <summary>
    /// <c>DeletePost : </c> Deletes a post.
    /// </summary>
    [HttpPost]
    public async Task<IActionResult> DeletePost([FromBody] DeleteItemRequestDTO objAPIRequest)
    {
        ...
        try
        {
            ...
            {
                objResponse = await objPostBAL.DeletePost(objAPIRequest);
            }
            else
            {
        ...
        catch (Exception ex)
        {
            ...
            codeLog.Error(ex, $"Step {nameof(DeletePost)}", string.Empty, $"Exception in {nameof(DeletePost)} Method");
        }
        stopwatch.Stop();
